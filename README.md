...
1. **A stack AI already knows** — Next.js, Tailwind, tRPC, Drizzle, Vercel AI SDK: the tools [AI models recommend](https://www.builder.io/blog/react-ai-stack-2026), so agents complete them correctly instead of hallucinating APIs
