...
// emits neither of the following, so re-add both by hand afterwards:
//   1. `.enableRLS()` on every table — the public schema can be exposed through
//      PostgREST with the anon key, and without RLS these tables (sessions,
