...
1. **Wire invitation emails** - invites currently only appear in-app, which means the invitee must already have an account to see them. `sendInvitationEmail` in the better-auth org plugin closes that gap (see [Production](/docs/launch/production))
