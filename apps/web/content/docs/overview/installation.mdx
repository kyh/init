...
Using a hosted database instead? Create one on [Vercel Postgres](https://vercel.com/docs/postgres) (or any Postgres host), point `POSTGRES_URL` at it, and run `pnpm db:push`.
