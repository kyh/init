...
A scheduled [OpenWiki](https://github.com/langchain-ai/openwiki) workflow regenerates an agent wiki (`openwiki/`) plus `AGENTS.md` from the code and opens a PR with the diff. Docs that describe the code as it is, not as it was three months ago. Setup is one secret - see [the workflow](https://github.com/langchain-ai/openwiki#readme) and `.github/workflows/openwiki-update.yml`.
