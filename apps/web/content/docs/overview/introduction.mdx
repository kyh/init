...
Ask an AI model what to build with and it names this stack: Next.js, Tailwind, tRPC, Drizzle, better-auth, Vercel AI SDK ([what AI recommends](https://www.builder.io/blog/react-ai-stack-2026)). That's not fashion - it's leverage. These libraries dominate the training data, so agents complete them correctly on the first try instead of hallucinating APIs.
