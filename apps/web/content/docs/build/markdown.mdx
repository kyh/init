...
These docs are written for humans. Agents can get their own - an optional [OpenWiki](https://github.com/langchain-ai/openwiki) workflow regenerates a wiki from the current code on a schedule. Setup lives in [Agent Wiki](/docs/build/agent-wiki).
